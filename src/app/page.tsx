    ...
    <>
      ...
      <section className="border-y border-border bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-4 py-10">
          <p className="text-center text-xs font-semibold text-text-muted uppercase tracking-[0.2em] mb-6">Yetkili Distribütörüyüz</p>
          <div className="flex items-center justify-center gap-8 md:gap-12 flex-wrap">
            {["FREUD", "NETMAK", "KRONBERG", "BOSCH", "KÖNIG", "TIDEWAY", "GKG", "PIRANHA"].map((brand) => (
              <span key={brand} className="text-base md:text-lg font-bold text-gray-300 hover:text-accent transition-colors cursor-pointer tracking-wider">
                {brand}
              </span>
            ))}
          </div>
